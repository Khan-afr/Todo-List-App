...
function App() { 
  ...
  return (
    < >
    <Navbar/> 
       <div className="mx-4 md:container md:mx-auto my-5 rounded-xl p-5 bg-violet-100 min-h-[80vh] md:w-[35%]">
        <h1 className='font-bold text-center text-3xl mx-2'>iTask - Manage your todos at one place</h1>
